...
var jogo = []; //recebe o controle do jogo, ou seja, guarda as posições das jogadas.
var tabuleiro = []; //controla os elementos visuais.
var quemJoga = 0; //0=jogador 1=cpu.
var verifica; //armazena o resultado de uma função que vai verificar se houve vencedor ou não.
